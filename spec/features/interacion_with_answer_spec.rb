...
RSpec.describe 'InteracionWithAnswers' do
  ...
  describe 'edit' do
    it 'shows answer\'s edit page after clicking of edit button' do
    ...
    it 'shows the answer with a changed body' do
  ...
  describe 'delete' do
    it 'questions\' page without a deleted answer after clicking of delete button' do
      visit question_path(question, locale: 'en')
