...
RSpec.feature "InteracionWithQuestions", type: :feature do
  let!(:question){ create(:question) }
  let(:user){ question.user }
  before { sign_in(user) }
  
  describe 'edit' do
    scenario 'shows question\'s edit page after clicking of edit link' do
    ...
    scenario 'shows the question with a changed body' do
  ...
  describe 'new' do
    scenario 'shows question\'s new page after clicking of new button' do
  ...
  describe 'delete' do
    scenario 'questions\' page without a deleted question after clicking of delete button' do
      visit question_path(question, locale: 'en')
  ...
  scenario 'shows question\'s page after clicking of show link' do 
    visit questions_path
